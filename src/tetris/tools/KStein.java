 ...
 *
 */
public class KStein implements Comparable <KStein>{
	 ...
	 */
	public KStein becomeBigger() {
		KStein a = new KStein(k+1);
		for(int i = 0; i < k; i++) {
			for (int j = 0; j < k; j++) {
	 ...
	 */
	private KStein copyStone() {
		KStein b = new KStein(k);
